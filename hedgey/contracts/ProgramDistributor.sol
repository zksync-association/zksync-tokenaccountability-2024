...
contract ProgramDistributor is ERC721Enumerable, ReentrancyGuard {
    ...
    constructor(
        address _factory,
        address _token
    ) ERC721("ProgramAwards", "PA") {
        factory = IProgramManagerFactory(_factory);
        token = IERC20(_token);
    }
